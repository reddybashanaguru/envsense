...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { title: "Reports", icon: <MdReport />, link: "/reports" },
    {
      title: "Calibration",
      icon: <MdSensors />,
      subItems: [{ title: "Certificates", link: "/calibration/certificates" }],
    },
    { title: "Audit Trail", icon: <MdDevicesOther />, link: "/audit-trail" },
    {
      ...
      subItems: [
        ...
        { title: "Users & Contacts", link: "/settings/users-contacts" },
        { title: "Locations", link: "/settings/locations" },
        { title: "Data Loggers", link: "/settings/data-loggers" },
        { title: "Set Periodical Reports", link: "/settings/set-periodical-reports" },
